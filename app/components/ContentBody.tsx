...
const formattedDate = formatDate(page.data.date)
  ...
  return (
    ...
    <Bounded as = "article">
      <div className="rounded-2xl border-2 border-slate-800 bg-slate-900 px-4 py-10 md:py-20 ">
        ...
        <div className="prose prose-1g prose-invert mt-12 w-full max-w-none md:mt-20">
